...
public interface ConsolidadosApi {
	...
	@ApiOperation(value = "Actualizar prioridad de ejecuci\u00F3n del archivo", nickname = "actualizarPosicionArchivoPUT", notes = "Actualiza la prioridad de ejecuci\u00F3n de los archivos.  ", response = InlineResponse200.class, authorizations = {
	    ...
	    @ApiResponses(value = { 
	        @ApiResponse(code = 200, message = "Modificaci\u00F3n exitosa", response = InlineResponse200.class),
		...
		ResponseEntity<?> actualizarPosicionArchivoPUT(
	    		...
	    		@ApiParam(value = "Identificador del archivo",required=true) @PathVariable("idArchivo") String idArchivo,@ApiParam(value = "peticion para modificar la posicion de un archivo"  )  @Valid @RequestBody ModificarPrioridadArchivoConsolidadoReq modificarPosicionReq);
