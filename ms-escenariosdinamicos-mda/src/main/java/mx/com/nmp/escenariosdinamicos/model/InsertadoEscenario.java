...
public class InsertadoEscenario {
	@JsonProperty("code")
	...
	public InsertadoEscenario code(String code) {
		this.code = code;
		return this;
	}
	...
	public InsertadoEscenario message(String message) {
	...
	public boolean equals(java.lang.Object o) {
		...
		InsertadoEscenario eliminarEscenariosRes = (InsertadoEscenario) o;
	...
	public String toString() {
		...
		sb.append("class InsertadoEscenario {\n");
