...
public class ExcelUtils {
	...
	private  void printHeader(Sheet sheet , Workbook workbook,Row row ) {
	...
	public byte[] crearExcelNotificaciones(List<PreciosVO> lstPrecios) {
		...
		printHeader(sheet,workbook, row);
		...
		try {
			...
			log.info("Ocurrio un error al generar el excel ::: "+e.getMessage());
			...
			try {
				...
				log.info("Ocurrio un error al cerrar el recurso del excel  :::"+e.getMessage());
			}
