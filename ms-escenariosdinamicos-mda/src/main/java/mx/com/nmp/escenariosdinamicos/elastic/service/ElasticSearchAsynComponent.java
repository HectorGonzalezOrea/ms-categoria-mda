...
public class ElasticSearchAsynComponent {
	...
	@Async
	public void ejecutarEscenariosDinamicos(EjecutarEscenarioDinamicoReq crearEscenariosRequest,String indexVenta,
			String indexGarantia) throws IOException {
		
		// consultar ventas
		List<MdaVentasVO> ventas = elasticService.scrollElasticVentas(indexVenta, crearEscenariosRequest.getInfoRegla(), false);
		// consultar garantias
