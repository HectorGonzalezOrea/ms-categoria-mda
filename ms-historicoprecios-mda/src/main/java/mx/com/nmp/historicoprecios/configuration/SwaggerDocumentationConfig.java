package mx.com.nmp.historicoprecios.configuration;
...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .description("API para almacenar el histórico de precios")
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("mx.com.nmp.historicoprecios.api"))
                    .build()
