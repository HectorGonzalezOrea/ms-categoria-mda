...
public class ProductoMidasVO {
	...
	public String toString() {
		return "ProductoMidasVO [descripcion=" + descripcion + ", estPrenda=" + estPrenda + ", precioVentaInicial="
				+ precioVentaInicial + ", alhajasAvaluoCompl=" + alhajasAvaluoCompl + ", avaluoComerc=" + avaluoComerc
				+ ", fechaVenta=" + fechaVenta + ", sku=" + sku + ", telefono=" + telefono + ", notaComercial="
				...
				+ ", fechaCompra=" + fechaCompra + ", cantidad=" + cantidad + ", ubicacionFisicaActv="
				+ ubicacionFisicaAct + ", numCuo=" + numCuo + ", antiguedad=" + antiguedad + ", idMercancia="
				+ idMercancia + ", estProducto=" + estProducto + ", alhajasTipoFactor=" + alhajasTipoFactor
				+ ", precioVentaAct=" + precioVentaAct + ", precioVentaSalida=" + precioVentaSalida + ", canalVentaAct="
				+ canalVentaAct + ", edoProducto=" + edoProducto + ", fechaUltimaModificacion="
				+ fechaUltimaModificacion + ", contratoOrigen=" + contratoOrigen + ", avaluoCc=" + avaluoCc
				+ ", expendio=" + expendio + ", notaPrendaria=" + notaPrendaria + ", valorMonteAct=" + valorMonteAct
				+ ", margenVenta=" + margenVenta + ", fechaAltaInventario=" + fechaAltaInventario + ", edoSucOrigen="
				+ edoSucOrigen + ", sistemaOrigen=" + sistemaOrigen + ", canalIngreso=" + canalIngreso + ", cp=" + cp
				+ ", partida=" + partida + ", tipoTransaccion=" + tipoTransaccion + ", alhajasKilates=" + alhajasKilates
				+ ", refrendos=" + refrendos + ", fechaIngDeposito=" + fechaIngDeposito + ", subramo=" + subramo
				+ ", discontinued=" + discontinued + ", productCategory=" + productCategory + "]";
	}
