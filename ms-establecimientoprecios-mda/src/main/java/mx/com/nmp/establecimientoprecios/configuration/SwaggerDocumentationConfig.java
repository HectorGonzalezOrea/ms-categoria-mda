...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("Establecimiento de Precios")
            .description("API para el establecimiento de precios en Midas, Plataforma Comercial y registro de histórico")
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("mx.com.nmp.establecimientoprecios.api"))
                    .build()
