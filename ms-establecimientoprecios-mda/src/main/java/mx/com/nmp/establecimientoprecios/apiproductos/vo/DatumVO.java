...
public class DatumVO {
	...
	public String toString() {
		...
		sb.append("class ProductoMidasVO {\n");
		...
		sb.append("    fechaVenta: ").append(toIndentedString(fechaVenta)).append("\n");
		...
		sb.append("    ubicacionFisicaActv: ").append(toIndentedString(ubicacionFisicaAct)).append("\n");
